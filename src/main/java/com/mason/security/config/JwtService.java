...
public class JwtService {
    ...
    private static final String  SECRET_KEY = "UEeQPqIeMlOTznt4K6DMbY1rPkcMCx/BzoNlm6IFI8Y=";
    ...
    private Claims extractAllClaims(String token){
        ...
        try {
            ...
            throw new RuntimeException("JWT 簽名校驗失敗: 無效的簽名或 token 被篡改", e);
        } catch (Exception e) {
            throw new RuntimeException("JWT 解析失敗: 無效的 token", e);
        }
    }
